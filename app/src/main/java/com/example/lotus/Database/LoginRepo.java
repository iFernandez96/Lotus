...
public class LoginRepo {
    ...
    public Statistics getStatisticsByUserID(int userID) {
        Future<Statistics> future = LoginDatabase.databaseWriteExecutor.submit(
                new Callable<Statistics>() {
                    @Override
                    public Statistics call() throws Exception {
                        return StatisticsDao.getStatisticsByUserID(userID);
                    }
                }
        );
        try {
        ...
        Future<Integer> future = LoginDatabase.databaseWriteExecutor.submit(
                new Callable<Integer>() {
                    ...
                    public Integer call() throws Exception {
                        return StatisticsDao.getTotalLogins();
                    }
                }
        );
        try {
    ...
    public void updateLastTrackerUse(String lastTrackerUse, int userID) {
        LoginDatabase.databaseWriteExecutor.execute(() -> {
    ...
    public void updateLastLogout(String lastLogout, int userID) {
        LoginDatabase.databaseWriteExecutor.execute(() -> {
    ...
    public void updateAllUserStatistics(int userID, float[] rangeHeadMovement, int totalLogins, int totalHeadTriggers,
                                        int totalTimesUsedTracker, int averageUseTime, String lastLogin, String lastLogout,
                                        String lastTrackerUse) {
        LoginDatabase.databaseWriteExecutor.execute(() -> {
            StatisticsDao.updateAllUserStatistics(userID, rangeHeadMovement, totalLogins, totalHeadTriggers,
