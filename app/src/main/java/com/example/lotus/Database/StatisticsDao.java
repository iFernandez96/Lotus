...
public interface StatisticsDao {
    ...
    void updateLastTrackerUse(String lastTrackerUse, int userID);
    ...
    void updateLastLogout(String lastLogout, int userID);
    ...
    @Transaction
    public default void updateAllUserStatistics(int userID, float[] rangeHeadMovement, int totalLogins, int totalHeadTriggers,
